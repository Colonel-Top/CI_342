                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <input id="name" type="text"
                                   class="form-control"
                                   name="name" required autofocus value="<?php echo($post['name']);?>">
                            <input id="id" type="hidden"
                                   class="form-control"
                                   name="id" required value="<?php echo($post['id']);?>">
                        </div>
                        ...
                        <div class="col-md-6 ">
                            ...
                            <select name="language" class="form-control"  style="width:100%;">
                                ...
                                <?php foreach ($categories as $g): ?>
                                    <option value="<?php echo($g['id']); ?>" <?php echo($post['language'] == $g['id'] ? "selected":"");?> > <?php echo($g['name']); ?></option>
